#!/bin/bash
# =============================================================================
# HAProxy Backup Node - Entrypoint
# =============================================================================
set +e

echo "============================================"
echo "  HAProxy Backup Node - Initialisation"
echo "============================================"

# Variables d'environnement
HAPROXY_NODE_NAME=${HAPROXY_NODE_NAME:-haproxy2}
HAPROXY_NODE_IP=${HAPROXY_NODE_IP:-172.30.0.12}
HAPROXY_ROLE=${HAPROXY_ROLE:-BACKUP}
...
# =============================================================================
# HAProxy Configuration - Workshop (Backup Node)
# =============================================================================
...
echo ""
echo "============================================"
echo "  HAProxy Backup Node - Ready"
echo "============================================"
echo ""
...
echo "  - VIP:        http://$VIP_ADDRESS:80 (si master down)"
echo ""
